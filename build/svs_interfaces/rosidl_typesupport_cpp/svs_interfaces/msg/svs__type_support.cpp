...
static const _SVS_type_support_symbol_names_t _SVS_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, svs_interfaces, msg, SVS)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, svs_interfaces, msg, SVS)),
  }
};
...
{
  return &::svs_interfaces::msg::rosidl_typesupport_cpp::SVS_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, svs_interfaces, msg, SVS)() {
  return get_message_type_support_handle<svs_interfaces::msg::SVS>();
}
